...
public class exe2 extends AppCompatActivity implements android.location.LocationListener {
    ...
    private void sendToStart() {
        ...
        Intent startIntent = new Intent(exe2.this, StartActivity.class);
    ...
    public void FirebaseChanges()
    {
        ...
        mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                Toast.makeText(getApplicationContext(), keys.toString()+locations.toString()+markers.toString(), Toast.LENGTH_LONG).show();
